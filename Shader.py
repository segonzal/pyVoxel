...
class Shader:
	...
	def bindAttributes(self,att_name,buffer,(size,type,normalized,stride,offset)):
	...
	def bindUniforms(self,uni_name,type,value):
		...
		if type == '1f':
			...
			glUniform2f(loc, value[0], value[1], value[2])
		elif type == '4f':
			glUniform2f(loc, value[0], value[1], value[2], value[3])
		elif type == '1i':
